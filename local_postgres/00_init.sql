...
(
    id_exchange bigint NOT NULL GENERATED BY DEFAULT AS IDENTITY ( INCREMENT 1 START 1 MINVALUE 1 MAXVALUE 9223372036854775807 CACHE 1 ),
    exchange_date timestamp(6) without time zone,
    send_book_date timestamp(6) without time zone,
    shipping_type character varying(255) COLLATE pg_catalog."default",
    exchange_offer_id bigint,
...
CREATE TABLE IF NOT EXISTS public.exchange_users
(
...
(
    id_survey bigint NOT NULL GENERATED BY DEFAULT AS IDENTITY ( INCREMENT 1 START 1 MINVALUE 1 MAXVALUE 9223372036854775807 CACHE 1 ),
    book_rating integer, --
    comment character varying(500) COLLATE pg_catalog."default", --
    ...
    id_exchange bigint, --
    id_user bigint, --
    id_user_rated bigint, --
    CONSTRAINT survey_pkey PRIMARY KEY (id_survey)
);
...
ALTER TABLE IF EXISTS public.exchange
    ADD CONSTRAINT fkki773tcy05ewof4ukci94ljbj FOREIGN KEY (exchange_offer_id)
...
ALTER TABLE IF EXISTS public.exchange_users
    ADD CONSTRAINT fkba4g9regr7yc9ivfydoty7sll FOREIGN KEY (user_id)
        REFERENCES public."user" (id_user) MATCH SIMPLE
        ON UPDATE NO ACTION
        ON DELETE NO ACTION;
...
ALTER TABLE IF EXISTS public.exchange_users
    ADD CONSTRAINT fkc98ojn07ne7nhggbxwehyfdkw FOREIGN KEY (exchange_id)
...
ALTER TABLE IF EXISTS public.state_history
    ADD CONSTRAINT fkkmka1pxa3p6dht8x5nalksj2k FOREIGN KEY (id_exchange)
        REFERENCES public.exchange (id_exchange) MATCH SIMPLE
        ON UPDATE NO ACTION
        ON DELETE NO ACTION;
...
ALTER TABLE IF EXISTS public.survey
    ADD CONSTRAINT fk1jqss1diuujyoy12vt87n2dfh FOREIGN KEY (id_exchange)
        REFERENCES public.exchange (id_exchange) MATCH SIMPLE
        ON UPDATE NO ACTION
        ON DELETE NO ACTION;
...
ALTER TABLE IF EXISTS public.survey
    ADD CONSTRAINT fk1m7oqytfehjt2aguy0sb391ly FOREIGN KEY (id_user)
        REFERENCES public."user" (id_user) MATCH SIMPLE
        ON UPDATE NO ACTION
        ON DELETE NO ACTION;
...
ALTER TABLE IF EXISTS public.survey
    ADD CONSTRAINT fk5mxutgyg82ss8jnixcnw627sa FOREIGN KEY (id_book)
        REFERENCES public.book (id_book) MATCH SIMPLE
        ON UPDATE NO ACTION
        ON DELETE NO ACTION;
...
ALTER TABLE IF EXISTS public.survey
    ADD CONSTRAINT fkqxgfc38qagbxlewf7yhbe8deh FOREIGN KEY (id_user_rated)
        REFERENCES public."user" (id_user) MATCH SIMPLE
        ON UPDATE NO ACTION
        ON DELETE NO ACTION;
